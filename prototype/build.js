...
const SITEMAP_URLS = [['/', 'en'], ['/ar/', 'ar'], ['/toppik/', 'en'], ['/ar/toppik/', 'ar'], ['/shop/', 'en'], ['/shop/toppik/', 'en'], ['/shop/viviscal/', 'en']].concat(catalog.categories.map((c) => ['/shop/category/' + c.slug + '/', 'en']), catalog.products.map((p) => ['/shop/' + p.slug + '/', 'en']));

...
function brandsPage(base) {
  return '<main id="shop-main" class="shop"><div class="wrap shop-page">' + crumbs(base, [['Shop']]) +
    '<div class="shop-head"><div><h1>Choose a Brand</h1><p class="muted">Genuine beauty, hair and skin care products, imported and distributed by Al Qabas Pharmacy L.L.C and delivered across Oman.</p></div></div>' +
